...
print(f"RMS Audio: {rms(audio):.3f}")
print("Clipping:", np.any(clipping))

plt.figure(figsize=(14,10))
plt.suptitle("ANALISIS KAWASAN WAKTU", fontsize=14, fontweight='bold')
plt.subplot(4,2,1)
plt.plot(t, audio)
...
plt.figure(figsize=(14,10))
plt.suptitle("ANALISIS KAWASAN FREKUENSI", fontsize=14, fontweight='bold')
plt.subplot(3,2,1)
